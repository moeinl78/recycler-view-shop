...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val itemList = arrayListOf<Item>(
            Item("Samsung Galaxy S22 Ultra", "228g / 229g, 8.9mm thickness", "Android 12, One UI 4.1", "Exp. release 2022, February 25", "https://fdn2.gsmarena.com/vv/bigpic/samsung-galaxy-s22-ultra-5g.jpg"),
